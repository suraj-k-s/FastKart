                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <?php
												$i = 0;
                                                $selQry = "select * from tbl_complaint c inner join tbl_shop s on s.shop_id=c.shop_id inner join tbl_user u on c.user_id = u.user_id where complaint_status='0'";
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <?php
												$i = 0;
                                                $selQry = "select * from tbl_complaint c inner join tbl_shop s on s.shop_id=c.shop_id inner join tbl_user u on c.user_id = u.user_id where complaint_status='1'";
                                               $rs = $Conn->query($selQry);
                                                while ($data = $rs->fetch_assoc()) {
