...
if(isset($_POST["btnsave"]))
{
	...
	$insQry="insert into tbl_shop(shop_name,shop_contact,shop_address,shop_email,location_id,shop_photo,shop_proof,shop_password,shop_doj)values('".$name."','".$contact."','".$address."','".$email."','".$location."','".$photo."','".$proof."','".$password."',curdate())";
